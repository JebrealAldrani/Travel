...
const Footer = () => {
  return (
    <footer className="flexCenter mb-24">
      <div className="padding-container max-container flex w-full flex-col gap14">
          ...
          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
            {FOOTER_LINKS.map((column) => (
              <FooterColumn title={column.title}>
                <ul className="regular-14 flex flex-col gap-4 tex-gray-30">
        ...
        <p className="regular-14 w-full text-center text-gray-30 mt-10">2025 Hilink | All rights reserved</p>
      </div>
    </footer>
  )
}
